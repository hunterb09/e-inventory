...
<?php
		...
		//เลือกหมายเลขซีเรียล วันที่เบิก รหัสผู้เบิก ท้ายสุด
		$sql0 = "SELECT *, DATE_FORMAT(Rec_date, '%d-%m-%Y') AS Rec_date
				 FROM stock_outmst ORDER BY Stout_serial desc";
...
?>
		<form id="form" method=post action="#" enctype="multipart/form-data">
			...
			<input name="btnSubmit" class="btn btn-primary" type="submit" value="พิมพ์" /></td>
		</form>
</div>
