...
$sql = "SELECT * FROM product ORDER BY P_id asc" or die("Error:" . mysqli_error());
...
<head>
    ...
    <link href="plugins/selectator/fm.selectator.css" rel="stylesheet">
    <link href="plugins/select-me/selectMe.css" rel="stylesheet">  
	<link href="css/bootstrap.min.css" rel="stylesheet">
	<script src="js/jquery.min.js"></script>
	<script src="js/bootstrap.min.js"></script>
    <script src="plugins/selectator/fm.selectator.js"></script>
				...
				<div class="modal-body">
					<form id="form" method=post action="product_insert.php" enctype="multipart/form-data">
						<div class="form-group">
							...
							<select name="G_name" id="G_name"  style="width: 400px">
