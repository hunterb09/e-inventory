<?php
	...
	if($_POST['P_group'] != ""){
		$_SESSION['P_group'] = $_POST['P_group'];
	}
	$dataT = $_SESSION['P_group'];

	//1. เชื่อมต่อ database:
	require("connection.php");
	
	$sql = "SELECT * FROM p_group WHERE P_group LIKE '%$dataT%' ";
...
<?php
	...
	//	 <a href="group_form.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">เพิ่มหมวดหมู่ </a>';
	//echo '<p></p>';
	//echo "<a href='group_search.php?ID='> ย้อนกลับ </a>";
