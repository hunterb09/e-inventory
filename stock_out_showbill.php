...
$(function() {
	$('button#index').click(function() {
		location.href = "stock_out_show.php";
	});
});
</script>
</head>
<body><br><br>
<div id="container">
<div id="head"><h4><center>บิลเบิกสินค้า </center></h4></div>
<div id="content">
<?php
		require("connection.php");

        //รับค่าไอดีที่จะแก้ไข
        $Stout_serial = mysqli_real_escape_string($link,$_GET['Stout_serial']);

		//เลือกหมายเลขซีเรียล วันที่เบิก รหัสผู้เบิก
		$sql0 = "SELECT * FROM stock_outmst WHERE Stout_serial = '$Stout_serial' ";
		...
		$sql2 = "SELECT * FROM stock_outdtl WHERE Stout_serial = '$Stout_serial' ";
		$result2 = mysqli_query($link,$sql2);	

		echo "<h5>เลขที่ใบเบิก: $Stout_serial</h5>";
			//เชื่อม 3ตาราง
			$sql = "SELECT stock_outdtl.*, product.P_id, product.P_name, product.P_group
			 			FROM stock_outdtl LEFT JOIN product
						ON stock_outdtl.P_id = product.P_id
						WHERE stock_outdtl.Stout_serial = '$Stout_serial'";
