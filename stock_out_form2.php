...
<body><br><br>
    <center>
        ...
        <form id="form" method=post action="stock_out_insert.php" name="frmprice">
            <table border="0" width="80%" align="center">
                <tbody>
                    <tr>
                        ...
                        <td class="text-left" width="10%"><input type="button" id="click_p" style="background-color: lightgreen" value="ค้นหา"></td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-left" width="10%"><select name='Pp_name' id='Pp_name'>
                                <?php while ($row2 = mysqli_fetch_array($result2)) { ?> <?php echo "<option value=" . $row2['Pp_name'] . " >" . $row2["Pp_name"] ?> </option><?php } ?>
                            </select></td>
